...
type PushContent struct {
	...
	Badge int               `json:"badge,omitempty" validate:"gt=0"`
	// must be "1"
	AutomaticallyCopy string `json:"automaticallyCopy,omitempty" validate:"oneof='0' '1'"`
	// value to be copied
